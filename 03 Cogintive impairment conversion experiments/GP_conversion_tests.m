...
results_conversion.final.independent.global.auc=AUCgpF;
results_conversion.final.independent.global.aucX=XGPF;
results_conversion.final.independent.global.aucY=YGPF;
...
XN=X;YN=Y;GN=G;
XN(ind,:)=[];YN(ind,:)=[];GN(ind)=[]; XI=X(ind,:);YI=Y(ind,:); 
...
%Linear kernels are computed WITHIN the GP function 
...
results_conversion.final.independent.feature.auc=AUCgpF;
results_conversion.final.independent.feature.aucX=XGPF;
results_conversion.final.independent.feature.aucY=YGPF;
...
results_conversion.final.independent.feature_no_conf.auc=AUCgpF;
results_conversion.final.independent.feature_no_conf.aucX=XGPF;
results_conversion.final.independent.feature_no_conf.aucY=YGPF;
